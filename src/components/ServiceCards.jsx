  ...
  return (
    <>
      ...
      {service == 1 && (
        ...
        { lang == "french" ? (
            "Nos offres, du nettoyage des sièges à l'élimination des poils d'animaux et aux traitements anti-odeurs, garantissent que l'intérieur de votre voiture est un havre de propreté et de détente. Rehaussez votre expérience de conduite avec une atmosphère accueillante et agréable."
          ):(
      ...
      <SectionParagraph $mode="services">
      { lang == "french" ? (
            "Laissez-vous tenter par le lavage et le polissage à la main ultimes, ou par nos soins de chromage pour raviver les surfaces chromées. Offrez à la partie inférieure et au moteur de votre véhicule un nettoyage en profondeur avec notre Service de Nettoyage Châssis-Moteur. Rehaussez l'attrait de votre véhicule avec notre Polissage de Carrosserie Supérieur pour des surfaces impeccables. Obtenez une apparence éblouissante et captivante qui perdure."
          ):(
            "Indulge in the ultimate hand wash and polish, or our Chrome care to revive chrome surfaces. Treat your vehicle's undercarriage and engine to a thorough cleansing with our Chassis-Engine Detailing. Elevate your vehicle's allure with our Superior Body Polishing for flawless surfaces. Achieve a stunning, head-turning appearance that lasts."
          )}
        ...
        <div class="ui-card_second">
          <SectionParagraph $mode="services">
          { lang == "french" ? (
            "Protégez votre véhicule avec notre Bouclier en Céramique, offrant une protection de peinture de pointe. Améliorez la visibilité les jours de pluie avec notre Répulsif Pluie. Faites-nous confiance pour restaurer habilement la finition de votre véhicule avec notre service de Restauration des Rayures."
          ):(
        ...
        <div class="ui-card_second">
          <SectionParagraph $mode="services">
          { lang == "french" ? (
            "Assurez des performances optimales avec notre Vérification des Vitres & du Moteur (sur demande), comprenant des inspections minutieuses et des compléments de liquides. Simplifiez votre expérience avec notre Option de Prise en Charge & Retour du Véhicule. Rehaussez la longévité de votre véhicule avec notre Entretien Mensuel, conçu pour maintenir votre trajet en condition optimale."
          ):(
